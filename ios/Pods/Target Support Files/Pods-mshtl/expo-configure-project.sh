...
with_node \
  ...
  --target "/Users/sulaimanengineer/Desktop/test/MASHTL_user--main/ios/Pods/Target Support Files/Pods-mshtl/ExpoModulesProvider.swift" \
  --entitlement "/Users/sulaimanengineer/Desktop/test/MASHTL_user--main/ios/mshtl/mshtl.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-application" "expo-asset" "expo-blur" "expo-constants" "expo-crypto" "expo-dev-launcher" "expo-dev-menu" "expo-device" "expo-document-picker" "expo-file-system" "expo-font" "expo-haptics" "expo-image" "expo-image-picker" "expo-keep-awake" "expo-linear-gradient" "expo-linking" "expo-location" "expo-media-library" "expo-notifications" "expo-router" "expo-splash-screen" "expo-symbols" "expo-system-ui" "expo-web-browser"
