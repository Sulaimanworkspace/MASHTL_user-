        ...
        <View style={styles.contentContainer}>
          ...
          <View style={styles.section}>
            ...
            <View style={styles.bulletList}>
              ...
              <Text style={styles.bulletPoint}>• فاتورة الخدمة تشمل (تكلفة عمل "مزود الخدمة"، وتكلفة قطع الغيار التي يوفرها "مزود الخدمة" إن وجدت، بالإضافة لضريبة القيمة المضافة 15%).</Text>
              ...
              <Text style={styles.bulletPoint}>• ضريبة الخدمة المضافة (15%) على اجمالي تكلفة عمل اليد فقط، وهي الزامية على المستهلك النهائي ولا يتحمل التطبيق أو "مزود الخدمة" دفعها.</Text>
          ...
          <View style={styles.section}>
            ...
            <Text style={styles.paragraph}>
              يعتبر المحتوى، الموجود في تطبيق مشتل او موقع مشتل ملك لشركة مشتل للخدمات التجارية ويمنع منعاً مطلقاً نسخ، إعادة توزيع، استخدام، أو طبع أي من هذه المواد أو أي جزء منها من "الموقع" أو من أية مواقع أخرى، إلا في الحدود التي تسمح بها القوانين السارية في المملكة العربية السعودية في هذا الشأن.
            </Text>
          </View>
        </View>
      </ScrollView>
