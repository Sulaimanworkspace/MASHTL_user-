...
const MessageScreen: React.FC = () => {
  ...
  // Define message handler outside of useEffect to avoid closure issues
  const handleNewMessage = React.useCallback(async (message: Message) => {
    // Get current user data to avoid stale closure
  ...
  useEffect(() => {
    ...
    const initializeChat = async () => {
      ...
      try {
        ...
        // Event handler functions will use the external useCallback version
